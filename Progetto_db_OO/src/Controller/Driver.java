	...
	*/
									    ...
									    ) throws SQLException 
	{
		...
		*/	
		...
		/*
		Vengono prese le consonanti del nome (o dei nomi, se ve ne � pi� di uno) nel loro ordine
	 	(primo nome, di seguito il secondo e cos� via) in questo modo: se il nome contiene quattro o pi� consonanti,
	...
	public boolean controlloPasswordDataBase( JPasswordField password, JTextField codiceFiscale)
	{
		...
		{
			System.out.println("il boolean psw � null");
			e.printStackTrace();
		}
		catch (Exception e1 )
		{
